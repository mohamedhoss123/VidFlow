...
export class VideoController {
  ...
  async create(
    @Payload() createVideoDto: CreateVideoRequest,
  ...
  async getVideo(@Param("id") params: string, @UserId() userId: string) {
    console.log(params);
    return this.videoService.getVideoWithQualities(params, userId);
  }
  @Get("download/:key")
